...
GMT = simFiniteGmeasure(par,w.delta = w.delta, r_x = r_x,minGamma = 1)
#--------------------------------------------------
...
x11()
x = GMT$x
conf = setConf(R = 2000,kappaVonMises=0,starAtTruth = FALSE, lBext = 1.2,jumpFactor = 0.1,splitFactor = 1,truncGamma = 1)
